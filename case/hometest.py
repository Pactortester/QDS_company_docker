...
class HomeTest(MyTestCase):
    ...
    def test_address(self):
        ...
        self.driver.find_element_by_css_selector(
            "#add_Address > table > tbody > tr:nth-child(1) > td:nth-child(2) > input").send_keys("{}".format(ss))
        print("收件人名称:{}".format(ss))
        self.driver.find_element_by_css_selector(
            "#add_Address > table > tbody > tr:nth-child(2) > td:nth-child(2) > input").send_keys("15624992422")
        self.driver.find_element_by_css_selector("#address_info").click()
        self.driver.find_element_by_css_selector(
            "#administrative > div > div.d-dropdown > div.tab-content.active.tab-province > dl.item.item-a-g.clearfix > dd > span:nth-child(1)").click()
        self.driver.find_element_by_css_selector(
            "#administrative > div > div.d-dropdown > div.tab-content.tab-city.active > dl.item.item-a-g.clearfix > dd > span:nth-child(1)").click()
        qq = unicode()
        self.driver.find_element_by_css_selector(
            "#add_Address > table > tbody > tr:nth-child(4) > td:nth-child(2) > textarea").send_keys("{}".format(qq))
    ...
    def test_official(self):
        ...
        self.assertEqual(1, 1, "此账号无官文可申请!")
        # time.sleep(1)
        #
        #
    ...
    def test_batch_payment(self):
        ...
        """待付款"""
        self.driver.find_element_by_css_selector(
            "#personalCenter2-rightContainer > div.order-page.brand-trade-page.trade-order > div.tabsPanel > ul > li:nth-child(2) > a").click()
        """全选订单批量支付"""
        self.driver.find_element_by_css_selector(
            "#personalCenter2-rightContainer > div.order-page.brand-trade-page.trade-order > div.tabsPanel > div > div > table > thead > tr > th:nth-child(1) > label").click()
        time.sleep(2)

        info_1 = self.driver.find_element_by_css_selector(
            "#personalCenter2-rightContainer > div.order-page.brand-trade-page.trade-order > div.tabsPanel > div > div > div.order-detail-fix > div > div.right > div > span").text
        print(info_1)

        number_1 = self.driver.find_element_by_css_selector(
            "#personalCenter2-rightContainer > div.order-page.brand-trade-page.trade-order > div.tabsPanel > div > div > div.order-detail-fix > div > div.right > div > span > i:nth-child(2) > i").text
        """立即付款"""
        self.driver.find_element_by_css_selector(
            "#personalCenter2-rightContainer > div.order-page.brand-trade-page.trade-order > div.tabsPanel > div > div > div.order-detail-fix > div > div.right > div > a").click()
        time.sleep(5)
        info_2 = self.driver.find_element_by_css_selector(
            "#personalCenter2-rightContainer > div > div.section-orderInfo.clearfix > div.order-info-box > div > h2").text
        print(info_2)
    ...
    def test_patent_cancel(self):
        ...
        self.driver.find_element_by_css_selector(
            "#personalCenter2-leftNav > ul > li.menu.open > ul > li:nth-child(1) > a").click()
        self.driver.find_element_by_css_selector(
            "#personalCenter2-rightContainer > div.order-page-tab > a.p-index").click()
        time.sleep(4)
        ...
        while True:
            ...
            self.driver.find_element_by_css_selector(
                "#personalCenter2-rightContainer > div.order-page > div.tabsPanel > div > div > table > tbody > tr:nth-child(1) > td:nth-child(7) > div > a.order-cancel-old").click()
    ...
    def test_copyright_cancel(self):
        ...
        self.driver.find_element_by_css_selector(
            "#personalCenter2-leftNav > ul > li.menu.open > ul > li:nth-child(1) > a").click()
        self.driver.find_element_by_css_selector(
            "#personalCenter2-rightContainer > div.order-page-tab > a.c-index").click()
        time.sleep(4)
