...
class CxZcTest(MyTestCase):
    ...
    def test_TrademarkSearchScreeningConditions(self):
        ...
        """筛选条件"""
        self.driver.find_element_by_css_selector(
            "#searchList > div.page-form.w-center > ul > li:nth-child(1) > a").click()
        number = random.randint(1, 45)
        lb = self.driver.find_element_by_css_selector(
            "#searchList > div.page-form.w-center > ul > li.search-category.open > div.category-show-box.select-show-category > a:nth-child({})".format(
                number)).text
        self.driver.find_element_by_css_selector(
            "#searchList > div.page-form.w-center > ul > li.search-category.open > div.category-show-box.select-show-category > a:nth-child({})".format(
                number)).click()
    ...
    def test_TrademarkSearchFollow(self):
        ...
        """点击关注"""
        self.driver.find_element_by_css_selector(
            "#searchList > div.page-content.w-center > div.page-content-left > ul > li:nth-child(1) > div.brand-status > div:nth-child(1) > span").click()
        time.sleep(2)
        # 确定弹框
    ...
    def test_TrademarkSearchBusiness(self):
        ...
        """点击后续业务"""
        self.driver.find_element_by_css_selector(
            "#searchList > div.page-content.w-center > div.page-content-left > ul > li:nth-child(1) > div.brand-status > div:nth-child(2) > a:nth-child(1)").click()
        windows = self.driver.window_handles
        self.driver.switch_to.window(windows[-1])
        time.sleep(2)
    ...
    def test_TrademarkMonitor(self):
        ...
        self.driver.get("https://so.quandashi.com/")
        dl.refresh()
        self.driver.find_element_by_name("key").send_keys(xz("famousTrandMark.txt").replace(".0", ""))
        time.sleep(2)
        self.driver.find_element_by_css_selector(
            "#btnSearchkey").click()
        time.sleep(5)
        ...
        result3 = self.driver.find_element_by_css_selector(
            "#searchDetail > div.page-brand > div > div.brand-left > div.brand-info > div > span:nth-child(3)").text
        print(result3)
    ...
    def test_group_search(self):
        ...
        # 取消全选
        self.driver.find_element_by_css_selector(
            "#searchList > div.page-checkbox.w-center > div > label:nth-child(1) > span").click()
        time.sleep(3)
        checkbox = random.randint(2, 10)
        check = self.driver.find_element_by_css_selector(
            "#searchList > div.page-checkbox.w-center > div > label:nth-child({}) > span".format(checkbox)).text
        print("搜索条件:" + check)
        self.driver.find_element_by_css_selector(
            "#searchList > div.page-checkbox.w-center > div > label:nth-child({}) > span".format(checkbox)).click()
        time.sleep(3)
        result_2 = self.driver.find_element_by_css_selector(
            "#searchList > div.page-content.w-center > div.page-content-left > div.search-top").text
        print(str(result_2))
    ...
    def test_ad(self):
        ...
        """点击广告"""
        self.driver.find_element_by_css_selector(
            "#searchList > div.page-content.w-center > div.page-content-left > div.list-banner > a > img").click()
        # 获取打开的多个窗口句柄
        windows = self.driver.window_handles
        # 切换到当前最新打开的窗口
        self.driver.switch_to.window(windows[-1])
