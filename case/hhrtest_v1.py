...
class HhrTest(MyTestCase):
    ...
    def test_full_business_1(self):
        ...
        print(yw)
        time.sleep(2)
        self.driver.find_element_by_css_selector("#addBusinessMgsBox > ul > li:nth-child(1) > div > dl > dd:nth-child(2)").click()
        time.sleep(2)
        ...
        print(xm)
        self.driver.find_element_by_css_selector("#addBusinessMgsBox > ul > li:nth-child(2) > div > dl > dd:nth-child({})".format(lx)).click()
        time.sleep(2)
        print("业务需求:"+yw + "_" + xm)
        ...
        print("订单价格:" + price)
        income = self.driver.find_element_by_css_selector("#addBusinessMgsBox > div.numAndPrice.clearfix > div.profitNum > span.earning.income-estimate").text
    ...
    def test_full_business_2(self):
        ...
        self.driver.find_element_by_css_selector("#addBusinessMgsBox > ul > li:nth-child(1) > div > input").click()
        time.sleep(2)
        lx = random.randint(1,7)
        qt = random.randint(3,4)
        yw = self.driver.find_element_by_css_selector(
            "#addBusinessMgsBox > ul > li:nth-child(1) > div > dl > dd:nth-child({})".format(qt)).text
        print(yw)
        time.sleep(2)
        self.driver.find_element_by_css_selector("#addBusinessMgsBox > ul > li:nth-child(1) > div > dl > dd:nth-child({})".format(qt)).click()
        time.sleep(2)
        self.driver.find_element_by_css_selector("#addBusinessMgsBox > ul > li:nth-child(2) > div > input").click()
        xm = self.driver.find_element_by_css_selector(
            "#addBusinessMgsBox > ul > li:nth-child(2) > div > dl > dd:nth-child({})".format(lx)).text
    ...
    def test_partner_clue_1(self):
        ...
        try:
            self.driver.find_element(By.CSS_SELECTOR,"#personalCenter2-rightContainer > div.clue-list > div.clue-list > div.tbody > div > a")
            a = True
        except:
            a = False
        if a is True:
            print("当前无线索,点击申请!")
            self.driver.find_element_by_css_selector("#personalCenter2-rightContainer > div.clue-list > div.clue-list > div.tbody > div > a").click()
            time.sleep(4)
            clue = self.driver.find_element_by_css_selector("#personalCenter2-rightContainer > div.clue-list > div.clue-list > div.tbody > div:nth-child(1) > div.t-info").text
            print(str(clue).replace("\n", " ").replace("认领",""))
            self.driver.find_element_by_css_selector("#personalCenter2-rightContainer > div.clue-list > div.clue-list > div.tbody > div:nth-child(1) > div.t-info > span.td-handle > a.button.claim_clue").click()  # tr-a claim_clue
        elif a is False:
            print("线索存在!")
            time.sleep(2)
    ...
    def test_partner_clue_2(self):
        ...
        """已认领 第一条线索信息"""
        self.driver.find_element_by_css_selector("#personalCenter2-rightContainer > div.clue-list > div.partner > a:nth-child(2)").click()
        info = self.driver.find_element_by_css_selector("#personalCenter2-rightContainer > div.clue-list > div.clue-list > div.tbody > div:nth-child(1) > div.t-info").text
        print("申请人详情:" + (str(info).replace("\n" ," ")).replace("展开","").replace("保护","").replace("退回",""))

        """点击展开线索集合(查看第一条线索详情)"""

        self.driver.find_element_by_css_selector("#personalCenter2-rightContainer > div.clue-list > div.clue-list > div.tbody > div:nth-child(1) > div.t-info > span.td-handle > a.switch").click()

        info_1 = self.driver.find_element_by_css_selector("#personalCenter2-rightContainer > div.clue-list > div.clue-list > div.tbody > div:nth-child(1) > div.t-box.scroll.active > table > tbody > tr:nth-child(1) > td > div.left.float-left").text
        print(info_1)

        info_2 = self.driver.find_element_by_css_selector("#personalCenter2-rightContainer > div.clue-list > div.clue-list > div.tbody > div:nth-child(1) > div.t-box.scroll.active > table > tbody > tr:nth-child(2)").text
        print("线索详情:" + (str(info_2).replace("\n" ," ")).replace("查看详情",""))

        self.driver.find_element_by_css_selector("#personalCenter2-rightContainer > div.clue-list > div.clue-list > div.tbody > div:nth-child(1) > div.t-box.scroll.active > table > tbody > tr:nth-child(2) > td.td-handle > a").click()
    ...
    def test_partner_clue_3(self):
        ...
        self.driver.find_element_by_css_selector("#personalCenter2-leftNav > ul > li.menu.open > ul > li:nth-child(2) > a").click()
        time.sleep(2)
        self.driver.find_element_by_css_selector("#personalCenter2-rightContainer > div.clue-list > div.partner > a:nth-child(5)").click()
        time.sleep(2)
    ...
    def test_partner_clue_4(self):
        ...
        clue_number = self.driver.find_element_by_css_selector("#personalCenter2-rightContainer > div.clue-list > div.clue-list > div.tbody > div:nth-child(1) > div.t-box.scroll.active > table > tbody > tr.tr-top > td > div.left.float-left > span.gray").text
    ...
    def test_partner_clue_5(self):
        ...
        self.driver.find_element_by_css_selector("#personalCenter2-rightContainer > div.clue-list > div.clue-list > div.tbody > div:nth-child(1) > div.t-info > span.td-handle > a.protect_clue.button").click()

        time.sleep(2)
        tip_1 = self.driver.find_element_by_css_selector("#layui-layer2 > div.layui-layer-content.layui-layer-padding").text
        print(tip_1)
        self.driver.find_element_by_link_text("确定").click()
        ...
        tip_2 = self.driver.find_element_by_css_selector("#personalCenter2-rightContainer > div > div.partner > span").text
        print(tip_2)

        info_2 = self.driver.find_element_by_css_selector("#personalCenter2-rightContainer > div > div.clue-list > div.tbody > div > div.t-info > span.applicant").text
        print("申请人:" + info_2)

        """点击取消保护"""
        self.driver.find_element_by_css_selector("#personalCenter2-rightContainer > div > div.clue-list > div.tbody > div > div.t-info > span.td-handle > a.button.cancel_clue").click()
