...
class ClueTest(MyTestCase):
    ...
    def test_clue1(self):
        ...
        ActionChains(self.driver).move_to_element(
            self.driver.find_element_by_css_selector("#section-tools > div > ul > li:nth-child(2)")).perform()
    ...
    def test_clue2(self):
        ...
        self.driver.find_element_by_css_selector(
            "body > div.section-banner > div.public-navbar > div > div > div > ul:nth-child(1) > li:nth-child(2) > h3 > a").click()
        # 获取打开的多个窗口句柄
    ...
    def test_clue3(self):
        ...
        """新版首页"""
        self.driver.find_element_by_css_selector(
            "body > div.section-banner > div.public-navbar > div > ul > li:nth-child(6) > a").click()
