...
class UpLoadTest(MyTestCase):
    ...
    def test_hhr_order_pic(self):
        ...
        """上传商标图片"""
        path = "logo/2019/04/10/ba3d13a2-1848-411d-a7c8-013bfaa3148b.jpg"
        self.driver.execute_script('document.getElementsByName("colorBrandPic")[0].value = "%s"' % path)
        self.driver.find_element_by_css_selector(
            "#personalCenter2-rightContainer > div > div.order-form-page > div > div.smartRegister-section > div.register-wrap.brandinfo-wrap > div.brand-info-wrap.form-wrap.show3 > ul > li.brand-fcontent > div > textarea").send_keys(
            "小鸡图片")
        ...
        time.sleep(3)
        opr1 = self.driver.find_elements_by_css_selector(
        ...
        time.sleep(2)
        opr2 = self.driver.find_elements_by_class_name("payable")
        # for o in self.driver.find_elements_by_class_name("payable"):
        print("订单提交成功，应付金额:" + opr2[0].text)
        oo = int(str(opr2[0].text).replace(".00", ""))
    ...
    def test_znzz_pic(self):
        ...
        opr4 = self.driver.find_elements_by_class_name("payable")
        # for o in self.driver.find_elements_by_class_name("payable"):
        print("订单提交成功，应付金额:" + opr4[0].text)
        oo = opr4[0].text
    ...
    def test_hwgs_pic(self):
        ...
        opr6 = self.driver.find_elements_by_css_selector("#total-price")
        # for a in self.driver.find_elements_by_css_selector("#total-price"):
        print("费用总计:" + opr6[0].text)
        aa = opr6[0].text
        ...
        opr5 = self.driver.find_elements_by_css_selector(
                "body > div.register-wrap > div.orderinfo-wrap > div.last-pay.personal-last-pay > ul > li.row-sense > em > i")
        # for i in self.driver.find_elements_by_css_selector(
        #         "body > div.register-wrap > div.orderinfo-wrap > div.last-pay.personal-last-pay > ul > li.row-sense > em > i"):
        print("总价:" + opr5[0].text)
        ii = opr5[0].text
        ...
        self.driver.find_element_by_css_selector(
            "body > div.register-wrap > div.orderinfo-wrap > div.last-pay.personal-last-pay > div > a").click()
        opr7 = self.driver.find_elements_by_class_name("payable")
        # for o in self.driver.find_elements_by_class_name("payable"):
        print("订单提交成功，应付金额:" + opr7[0].text)
        oo = opr7[0].text
