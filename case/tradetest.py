...
from utils.random import unicode, patent_name
...
class TradeTest(MyTestCase):
    ...
    def test_trade_1(self):
        ...
        trade = unicode()
        self.driver.find_element_by_css_selector(
            "#app > div > div.brandMarketBox > div.brandSearchBox > div > div > input[type=\"text\"]").send_keys(trade)
        print("商标名称:" + trade)
        self.driver.find_element_by_css_selector(
            "#app > div > div.brandMarketBox > div.brandSearchBox > div > div > a").click()
        time.sleep(2)
        number = self.driver.find_element_by_css_selector(
            "#app > div > div.brandMarketBox > div.searchCriteriaBox > dl.CompreRanking > dd:nth-child(3) > span").text
        number1 = int(number)
    ...
    def test_trade_2(self):
        ...
        self.driver.find_element_by_css_selector(
            "#app > div > div.brandMarketBox > ul > li:nth-child({})".format(brand)).click()
        ...
        name_1 = self.driver.find_element_by_css_selector(
            "#app > div > div.brandDetailMsgBox > div.brandMsgBox > div.brandMsg > dl > dt").text
        print(name_1)
        self.assertIn(str(name_1), str(name))
        self.driver.find_element_by_css_selector(
            "#app > div > div.brandDetailMsgBox > div.brandMsgBox > div.brandMsg > dl > dd:nth-child(9) > a:nth-child(2)").click()
        time.sleep(2)
        ...
        price_1 = self.driver.find_element_by_css_selector(
            "#app > div > div.shoppingCarBox > div.totalMoney > div > p > span").text
        ...
        price_2 = self.driver.find_element_by_css_selector(
            "#app > div > div.shoppingCarBox > div.totalMoney > div > p > b").text
        print(price_2)
        ...
        self.driver.find_element_by_css_selector(
            "#app > div > div.shoppingCarBox > div.userMsg > div > dl:nth-child(1) > dd > input[type=\"text\"]").send_keys(
            patent_name())
        self.driver.find_element_by_css_selector(
            "#app > div > div.shoppingCarBox > div.userMsg > div > dl:nth-child(2) > dd > input[type=\"text\"]").send_keys(
            "15624992498")
        self.driver.find_element_by_css_selector(
            "#app > div > div.shoppingCarBox > div.userMsg > div > dl:nth-child(3) > dd > input[type=\"text\"]").clear()
        self.driver.find_element_by_css_selector(
            "#app > div > div.shoppingCarBox > div.userMsg > div > dl:nth-child(3) > dd > input[type=\"text\"]").send_keys(
            "1456470138@qq.com")
    ...
    def test_trade_3(self):
        ...
        self.driver.find_element_by_css_selector(
            "#app > div > div.brandMarketBox > ul > li:nth-child({}) > div > p > a:nth-child(1)".format(brand)).click()

        self.driver.find_element_by_css_selector(
            "#app > div > div:nth-child(6) > div > div > p:nth-child(1) > input[type=\"text\"]").send_keys(unicode())
        self.driver.find_element_by_css_selector(
            "#app > div > div:nth-child(6) > div > div > p:nth-child(2) > input[type=\"text\"]").send_keys(
            "15624992422")
    ...
    def test_trade_4(self):
        ...
        self.driver.find_element_by_css_selector(
            "#app > div > div.brandMarketBox > ul > li:nth-child({}) > div > p > a:nth-child(2)".format(brand)).click()

        self.driver.find_element_by_css_selector(
            "#app > div > div.header-wrap.clearfix > div.header-right.clearfix > p.favoriteEnter.favoAct").click()

        # 搜索已经收藏的商标
        self.driver.find_element_by_css_selector(
            "#app > div > div > div.collectionFolderSwiper > div > div.searchCondition.clearfix > div.inputConditionBox.clearfix > div.brandName > input[type=\"text\"]").send_keys(
            name)

        self.driver.find_element_by_css_selector(
            "#app > div > div > div.collectionFolderSwiper > div > div.operationBox > div > a:nth-child(4)").click()

        name_1 = self.driver.find_element_by_css_selector(
            "#app > div > div > div.collectionFolderSwiper > ul > li > div.itemInner > div > b").text
    ...
    def test_trade_5(self):
        ...
        print("商标名称:" + brand)
        self.driver.find_element_by_css_selector(
            "#app > div > div > div.collectionFolderSwiper > ul > li > div.itemInner > div > p > a:nth-child(2)").click()
    ...
    def test_trade_8(self):
        ...
        self.driver.find_element_by_css_selector(
            "#app > div > div.header-wrap.clearfix > div.header-left > p > a:nth-child(2)").click()

        time.sleep(2)
        brand = random.randint(1, 10)
        print(brand)
        info = self.driver.find_element_by_css_selector(
            "#app > div > div.purchaseDemandBox.clearfix > ul > li:nth-child({})".format(brand)).text

        print("求购信息:" + str(info).replace("\n", " "))
        self.driver.find_element_by_css_selector(
            "#app > div > div.purchaseDemandBox.clearfix > ul > li:nth-child({}) > p.recBrand > a > img".format(
                brand)).click()
        time.sleep(2)
    ...
    def test_trade_10(self):
        ...
        result = self.driver.find_element_by_css_selector(
            "#app > div > div.brandMarketBox > div.searchCriteriaBox > dl.CompreRanking > dd:nth-child(3)").text
        print(result)
        number = self.driver.find_element_by_css_selector(
            "#app > div > div.brandMarketBox > div.searchCriteriaBox > dl.CompreRanking > dd:nth-child(3) > span").text
        number1 = int(number)
        ...
        if number1 == 0:
            ...
            print(self.driver.find_element_by_css_selector(
                "#app > div > div.brandMarketBox > ul > li:nth-child(1) > div").text)

        selected = self.driver.find_element_by_css_selector(
            "#app > div > div.brandMarketBox > div.searchCriteriaBox > dl.SelectedConditions > dd").text
    ...
    def test_trade_11(self):
        ...
        self.driver.find_element_by_css_selector(
            "#app > div > div.brandMarketBox > div.searchCriteriaBox > dl.brandPrice.chooseType > dd.inputNum > input[type=\"text\"]:nth-child(1)").send_keys(
            low)
        self.driver.find_element_by_css_selector(
            "#app > div > div.brandMarketBox > div.searchCriteriaBox > dl.brandPrice.chooseType > dd.inputNum > input[type=\"text\"]:nth-child(3)").send_keys(
            high)
    ...
    def test_trade_13(self):
        ...
        time.sleep(2)
        self.driver.find_element_by_css_selector(
            "#personalCenter2-leftNav > ul > li:nth-child(3) > ul > li:nth-child(2) > a").click()

        self.driver.find_element_by_css_selector(
            "#personalCenter2-rightContainer > div.order-page.brand-trade-page > div.tabsPanel > div > div.table-box > table > thead > tr > th:nth-child(1) > label > input").click()

        info = self.driver.find_element_by_css_selector(
            "#personalCenter2-rightContainer > div.order-page.brand-trade-page > div.tabsPanel > div > div.list-handle > div.handle-right > span").text

        print(str(info))

        result = self.driver.find_element_by_css_selector(
            "#personalCenter2-rightContainer > div.order-page.brand-trade-page > div.tabsPanel > div > div.table-box > table > tbody").text
        print((str(result).replace("查看 删除", " ")).replace("\n", " "))

        self.driver.find_element_by_css_selector(
            "#personalCenter2-rightContainer > div.order-page.brand-trade-page > div.tabsPanel > div > div.list-handle > div.handle-right > a").click()
        time.sleep(2)
        self.driver.find_element_by_css_selector(
            "#layui-layer1 > div.layui-layer-btn.layui-layer-btn- > a.layui-layer-btn0").click()

        info2 = self.driver.find_element_by_css_selector(
            "#personalCenter2-rightContainer > div.order-page.brand-trade-page > div.tabsPanel > div > div.table-box > table > tbody > tr > td > div > span").text
        print(str(info2))
    ...
    def _trade_14(self):
        ...
        time.sleep(2)
        self.driver.find_element_by_css_selector(
            "#personalCenter2-leftNav > ul > li:nth-child(3) > ul > li:nth-child(1) > a").click()

        self.driver.find_element_by_css_selector(
            "#personalCenter2-rightContainer > div.order-page.brand-trade-page.trade-order > div.tabsPanel > div > div.table-box > table > thead > tr > th:nth-child(1) > label > input").click()

        info = self.driver.find_element_by_css_selector(
            "#personalCenter2-rightContainer > div.order-page.brand-trade-page.trade-order > div.tabsPanel > div > div.list-handle > div.handle-right > span").text

        print(str(info))

        result = self.driver.find_element_by_css_selector(
            "#personalCenter2-rightContainer > div.order-page.brand-trade-page.trade-order > div.tabsPanel > div > div.table-box > table > tbody").text
        print((str(result).replace("查看 删除", " ")).replace("\n", " "))

        self.driver.find_element_by_css_selector(
            "#personalCenter2-rightContainer > div.order-page.brand-trade-page.trade-order > div.tabsPanel > div > div.list-handle > div.handle-right > a").click()
        time.sleep(2)
        self.driver.find_element_by_css_selector(
            "#layui-layer1 > div.layui-layer-btn.layui-layer-btn- > a.layui-layer-btn0").click()
